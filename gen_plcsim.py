...
SAMPLE_IL_7 = """// === Program 7: 3-Wire Motor Control ===
// X0: STOP pushbutton (NC field contact; ON here means pressed/open)
// X1: START pushbutton (NO)
// X2: overload trip (ON means tripped)
// Y0: motor starter coil
// Y1: motor running pilot light
// Logic: (START OR sealed-in Y0) AND NOT STOP AND NOT OVERLOAD
...
SAMPLE_IL_8 = """// === Program 8: ORB Block OR ===
// Demonstrates ORB: two series branches in parallel
// Y0 = (X0 AND X1) OR (X2 AND X3)
// Turn on X0+X1 or X2+X3 to energize Y0.
...
SAMPLE_IL_9 = """// === Program 9: ANB Block AND ===
// Demonstrates ANB: two parallel groups in series
// Y0 = (X0 OR X1) AND (X2 OR X3)
// Turn on one input from each group to energize Y0.
...
SAMPLES = [SAMPLE_IL, SAMPLE_IL_2, SAMPLE_IL_3, SAMPLE_IL_4, SAMPLE_IL_5, SAMPLE_IL_6, SAMPLE_IL_7, SAMPLE_IL_8, SAMPLE_IL_9]
SAMPLE_NAMES = [
...
MAIN_WINDOW_METHODS = [
    ...
    method('XInput_Pressed', 'sender As DesktopButton', '', [
